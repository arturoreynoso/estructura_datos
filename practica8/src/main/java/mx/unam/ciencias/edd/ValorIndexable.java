...
public class ValorIndexable<T>
	...
	if (this.valor == valorIndexable.getValor())
	    return 0;
	else if (this.valor < valorIndexable.getValor())
	    return -1;
	else
	    return 1;
    }
    ...
    @Override public boolean equals(Object objeto) {
        ...
        // Aquí va su código.
	if (elemento.equals(valorIndexable.elemento) &&
			    valor == valorIndexable.valor &&
			    indice == valorIndexable.indice)
	    return true;
	return false;
    }
    ...
    @Override public String toString() {
        // Aquí va su código.
	String cadena = String.format("%s:%2.9f", elemento, valor);
	return cadena;
    }
}
